...
class ViewController: UIViewController, LLAirportDatabaseDelegate, LLFloorDelegate, LLMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        // Get an instance of the LLAirportDatabase, register as its delegate and load the venue: LAX airport
    ...
    func customRecommendedPlaces() -> [Any] {
        ...
        let customPOIRecommendedPlace = LLPlace(behavior: LLPlaceBehaviorPOI, values: ["519"], displayName: "Departure Gate", andUI: ui)
        customRecommendedPlaces.append(customPOIRecommendedPlace as Any)
        
        // Create a custom Recommended Place to trigger a search
//        let customSearchRecommendedPlace = LLPlace(behavior: LLPlaceBehaviorSearch, values: ["magazines"], displayName: "Magazines", andUI: ui)
