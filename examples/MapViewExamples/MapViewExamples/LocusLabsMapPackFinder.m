...
+ (LocusLabsMapPackFinder *)mapPackFinder
{
    ...
    NSString *subDirectory = @"locuslabs";
    NSString *directory = [bundle.resourcePath stringByAppendingPathComponent:subDirectory];
    return [LocusLabsMapPackFinder mapPackFinderWithDirectory:directory];
}
